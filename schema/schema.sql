...
CREATE TABLE `pistage_run_tab` (
  ...
  `workflow_namespace` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `uk_run` (`workflow_namespace`,`workflow_identifier`,`create_time`)
...
CREATE TABLE `pistage_snapshot_tab` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_snapshot` (`workflow_namespace`,`workflow_identifier`,`content_hash`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
CREATE TABLE `job_run_tab` (
  ...
  KEY `idx_job_run` (`workflow_namespace`, `workflow_identifier`, `job_name`, `create_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
